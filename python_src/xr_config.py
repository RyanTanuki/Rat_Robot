...
COLOR_FOLLOW_SET = {'red': 0, 'green': 1, 'blue': 2, 'violet': 3, 'orange':4,'none':5}		# 颜色跟随功能颜色区间下标设置，在socket通信中使用
COLOR_FOLLOW_INDEX = { 0:'red', 1:'green', 2:'blue', 3:'violet', 4:'orange',5:'none'}  #颜色字典索引
COLOR_INDEX = 5			# 颜色区间阈值下标，在socket通信中改变
